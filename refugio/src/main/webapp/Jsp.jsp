...
<html>
    ...
    <body>
        ...
        <table border="1">
            ...
            <%
                ArrayListLista<Mascotas> mascotas = (ArrayListLista<Mascotas>) request.getAttribute("mascotas");
                for (Mascotas mascota : mascotas.getLista()) {
            ...
            <tr>
                ...
                <td><%= mascota.getColor()%></td>
                <td><%= mascota.getEdad()%></td>
                <td><%= ((Felino) mascota).getNumeroVidas()%></td>
                <td>
                    <form action="eliminarMascota" method="POST">
                        <input type="hidden" name="nombre" value="<%= mascota.getNombre()%>">
                        <button type="submit">Eliminar</button>
